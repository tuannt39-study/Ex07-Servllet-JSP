...
import vn.its.model.Oto.BaoHiem;
import vn.its.model.Oto.HangSanXuat;
...
public class OtoDAOImp implements OtoDAO {
	...
	public void create(Oto oto) {
		PreparedStatement pstm = null;
		try {
			String create = "INSERT INTO ITSOL.OTO (BIENKIEMSOAT, TENXE, NAMSANXUAT, HANGSANXUAT, GHICHU) "
					+ "VALUES (?, ?, ?, ?, ?)";
