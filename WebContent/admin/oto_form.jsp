...
<title>Form OTO</title>
</head>
<body>
	<form method="POST" action='OtoController' name="frmAddUser">
		Ma Xe : <input type="text" readonly="readonly" name="maXe" value="<c:out value="${oto.maXe}" />" /> <br /> 
